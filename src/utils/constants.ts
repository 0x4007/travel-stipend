...
// Other constants
export const DEFAULT_COST_OF_LIVING_INDEX = 100; // Base cost of living index
export const INTERNATIONAL_INTERNET_ALLOWANCE = 15; // Daily internet allowance for international travel
