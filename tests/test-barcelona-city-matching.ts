...
const exactMatches = ["Barcelona", "Barcelona, Spain", "Barcelona, Philippines", "Barcelona, Venezuela"];
...
const spellingVariations = ["Barselona", "Barcellona", "Barçelona", "Barthelona"];
