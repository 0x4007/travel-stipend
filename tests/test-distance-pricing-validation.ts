...
This test compares distance-based pricing with actual Google Flights prices */ async function testDistancePricingValidation() {
  const testRoutes = [
    { origin: "Seoul, South Korea", destination: "Barcelona, Spain" },
    { origin: "Tokyo, Japan", destination: "Paris, France" },
    { origin: "Singapore", destination: "London, UK" },
    { origin: "Hong Kong", destination: "Madrid, Spain" },
    { origin: "Bangkok, Thailand", destination: "Rome, Italy" },
  ];
